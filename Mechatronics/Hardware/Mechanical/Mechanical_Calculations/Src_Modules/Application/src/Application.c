...
void thirdMenuInstructions(void){
    printf("---Menu de cálculos---\n\n"
           ...
           "Oprime 2 para ver los calculos de los soportes\n"
           "Oprime 3 para ver los calculos de la Caja del Resorte\n"
           "Oprime 4 para ver los calculos de la Base\n"
           "Oprime 5 para ver los calculos de la Flecha\n"
